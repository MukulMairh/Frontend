...
let bill = 275;
let tip = bill >= 50 && bill <= 300 ? bill * 0.15 : bill * 0.2; //Did the logical part here only, so that in the next step we just need to calculate the total bill. 
let total = bill + bill + tip;

console.log(`Bill was ${bill}, the tip was ${tip}, and the total value is ${total}. `);
